...
<head>
 ...
 <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<c:url value='/resources/signin.css'/>" />
...
<div class="container">
      ...
      <form class="form-signin" action="${contextPath}/user/login" method="post">
...
<form action="user/login" method="post">
	...
	<a href="${contextPath}/admin/login">login an admin</a><br/>
 <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="../../assets/js/ie10-viewport-bug-workaround.js"></script>
