...
<table border="1" cellpadding="5" cellspacing="5">
		<c:forEach var="sendHistory" items="${senderHistories}">
			<tr>
				<td>you send ${sendHistory.firstName}${sendHistory.recieverLastName} total ${sendHistory.amount}</td>
				<td>${sendHistory.comment}</td>
				<td>${sendHistory.date}</td>	
			</tr>
		</c:forEach>
	</table>
 ...
 <table border="1" cellpadding="5" cellspacing="5">
		<c:forEach var="recieverHistory" items="${recieverHistories}">
			<tr>
				<td>${recieverHistory.sender} send you total:${recieverHistory.amount}</td>
				<td>${recieverHistory.date}</td>		
			</tr>
		</c:forEach>
	</table>
