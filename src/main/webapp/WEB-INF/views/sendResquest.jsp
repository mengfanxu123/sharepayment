...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Send Friends Request</title>
</head>
<body>
	...
	<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
	<h1>Please input friends Request to Add Friends</h1>
	<form:form action="${contextPath}/user/sendRequest" commandName="friendsMsg"
		 method="post">
		<table>
			<tr>
				<td>Posted By</td>
			...
			<tr>
			<td>request friend Name:</td>
			<td><form:input path="requestName" size="30"
						required="required" /> <font color="red"><form:errors
							path="requestName" /></font></td>
			</tr>
