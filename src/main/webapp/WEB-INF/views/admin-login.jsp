...
<div class="container">
      ...
      <form class="form-signin" action="${contextPath}/admin/login" method="post">
        <h2 class="form-signin-heading">Please sign in with admin name</h2>
...
<form action="user/login" method="post">
	...
	<a href="admin/login.htm">Register an admin</a><br/>
 <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="../../assets/js/ie10-viewport-bug-workaround.js"></script>
